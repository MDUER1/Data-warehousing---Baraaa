...
and three schemas called "bronze, silver and gold" following the Medallion Architecture.

Warning: Running this script will drop the entire 'DataWarehouse' database if it exists. 
All data will therefor be lost and permanently deleted. Proceed with caution, and ensure 
